...
![Me]({{ site.baseurl }}/assets/img/about.jpg){:style="float: left; height: 250px; margin-top: 10px; padding-right: 20px; padding-left: 0px; margin-bottom: 5px;"}
...
I've been in the software industry since 2016 primarily focusing on iOS application development and have been personally working on graphics programming since 2015 in my spare time. I am currently working as a **Software Engineer** focusing on computer graphics applications at [LiveRoom](https://liveroom.xyz), Sri Lanka's premiere computer graphics solutions provider.
